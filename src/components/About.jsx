...
import standeeImg from '../assets/Lol standee jpg.jpg';
import instaPostImg from '../assets/insta_post_captured.png';

const About = () => {
    return (
        <section id="about" className="about-section" style={{ padding: '100px 0', position: 'relative', background: 'var(--color-bg-main)' }}>
            <div className="container">
                <div className="about-grid" style={{
                    ...
                    >
                        ...
                        <h3 className="about-heading" style={{ fontSize: '40px', marginBottom: '20px', fontFamily: 'var(--font-serif)', color: 'var(--color-text-heading)' }}>About Lead O’Latino World Congress
                        </h3>
                        ...
                        <div className="about-stats" style={{ display: 'flex', gap: '30px' }}>
                            <div className="about-stats-box" style={{ textAlign: 'center', padding: '16px 24px', background: 'var(--color-gold-subtle)', borderRadius: '12px', border: '1px solid var(--color-border-gold)' }}>
                    ...
                    >
                        <a
                            href="https://www.instagram.com/leadolatino_afrolatinfestival?igsh=MTFtejJhZXFydzhvbw%3D%3D&utm_source=qr"
                            target="_blank"
                        ...
                        >
                            ...
                            <span style={{ fontSize: '17px', textTransform: 'lowercase', letterSpacing: '2px', color: 'var(--color-gold-dark)', fontWeight: '600' }}>@leadolatino_afrolatinfestival</span>
                        </a>
                        ...
                        >
                            ...
                            >
                                <div style={{ textAlign: 'center' }}>
                                    ...
                                    <p style={{ fontSize: '10px', fontWeight: '700', color: 'var(--color-gold-dark)', margin: 0 }}>LEAD O'LATINO</p>
                                </div>
                            </motion.div>
                        </a>
                    </motion.div>
